...
% Load trained model
svmMdl_Linear = loadCompactModel('SVMModel_1_Linear_S1');
svmMdl_RBF = loadCompactModel('SVMModel_1_RBF_S1');
svmMdl_Polynomial = loadCompactModel('SVMModel_1_Polynomial_S1');
% Testing model
% 1. Load image
load ('Testextracted_feature_S1.mat')
fitur = Testextracted_feature_S1(:,1:106);
labeltest = Testextracted_feature_S1(:,107);
